...
export class Generated1702456938373 implements MigrationInterface {
    name = 'Generated1702456938373'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "song_entity" ADD "musicGenreId" integer`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "song_entity" DROP COLUMN "musicGenreId"`);
    }
